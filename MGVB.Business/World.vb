Public Class World
    ...
    Private Sub InitializeVerbs()
        ...
        Data.Verbs(VerbIdentifier.North) = "N"
        Data.Verbs(VerbIdentifier.South) = "S"
        Data.Verbs(VerbIdentifier.East) = "E"
        Data.Verbs(VerbIdentifier.West) = "W"
        Data.Verbs(VerbIdentifier.Up) = "U"

        '3020 VB$(6)="D":VB$(7)="CON":VB$(8)="DRO":VB$(9)="SUI"
        Data.Verbs(VerbIdentifier.Down) = "D"
        Data.Verbs(VerbIdentifier.Connect) = "CONNECT"
        Data.Verbs(VerbIdentifier.Drop) = "DROP"
        ...
        Data.Verbs(VerbIdentifier.Press) = "PRESS"
        Data.Verbs(VerbIdentifier.Pull) = "PULL"
        Data.Verbs(VerbIdentifier.Push) = "PUSH"
        Data.Verbs(VerbIdentifier.Examine) = "EXAMINE"

        '3050 VB$(18)="OPE":VB$(19)="GO":VB$(20)="CLI":VB$(21)="JUM"
        Data.Verbs(VerbIdentifier.Open) = "OPEN"
        Data.Verbs(VerbIdentifier.Go) = "GO"
        Data.Verbs(VerbIdentifier.Climb) = "CLIMB"
        Data.Verbs(VerbIdentifier.Jump) = "JUMP"

        '3060 VB$(22)="GET":VB$(23)="LOO":VB$(24)="SAV":VB$(25)="LOA"
        Data.Verbs(VerbIdentifier.Get) = "GET"
        Data.Verbs(VerbIdentifier.Look) = "LOOK"
        Data.Verbs(VerbIdentifier.Save) = "SAVE"
        Data.Verbs(VerbIdentifier.Load) = "LOAD"

        '3070 VB$(26)="DIG":VB$(27)="STA"::VB$(28)="HEL":VB$(29)="SCO"
        Data.Verbs(VerbIdentifier.Dig) = "DIG"
        Data.Verbs(VerbIdentifier.Stash) = "STASH"
        Data.Verbs(VerbIdentifier.Help) = "HELP"
        Data.Verbs(VerbIdentifier.Score) = "SCORE"
        ...
        '3090 VB$(34)="ENT"
        Data.Verbs(VerbIdentifier.Enter) = "ENTER"
    End Sub
